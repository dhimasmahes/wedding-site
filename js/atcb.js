...
function atcb_generate(button, buttonId, data) {
  ...
  buttonTrigger.innerHTML = '<span class="atcb_icon"></span>';
  buttonTrigger.innerHTML += '<span class="atcb_text"><i class="fa-solid fa-calendar-plus"></i> ' + (data['label'] || 'Add to Calendar') + '</span>';
